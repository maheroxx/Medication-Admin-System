...
if ($result != null) {
	while ($row = $result->fetch_array()) { 
		...
		$html .= "<td>$gender</td>";
		$html .= "<td>$id</td>";
		$html .= "<td><a href = \"nurseProfile.php?ID=" . $row['id'] . "\" class='btn btn-primary'>View</a>";
		$html .= "<a href = \"updateNurseProfile.php?ID=" . $row['id'] . "\" class='btn btn-primary'>Update</a></td>";
