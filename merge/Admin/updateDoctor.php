 ...
 if(isset($_POST['update']))
{
   ...
   $query = "UPDATE `doctor` SET `name`='".$name."',`surname`='".$surname."',`nric`='".$nric."',`dob`='".$dob."',`age`='".$age."',`email`='".$email."',`phone`='".$phone."',`address`='".$address."',`bloodgroup`='".$bloodgroup."',`gender`='".$gender."' WHERE `id` = $id";
   ...
   if($result)
   {
	...
	echo ' alert("Updated Doctor Successfully")';
	echo '</script>';
   }else{
	echo '<script type="text/javascript">';
	echo ' alert("Update Doctor Failed")';
	echo '</script>';
   }
